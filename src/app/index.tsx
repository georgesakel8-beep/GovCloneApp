διορθωσε μου λιγο τον κωδικα σβησε μοιυ οτι εχει σχεση με twillio και βαλε οτι χρειαζεται για το brevo import React, { useEffect, useRef, useState } from 'react';
